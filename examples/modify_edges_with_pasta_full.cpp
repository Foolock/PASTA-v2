...
int main(int argc, char* argv[]) {
  ...
  while (count < num_incre_itr) {
    ...
    graph.run_graph_pasta_partition_full(matrix_size, num_streams, max_parallelism);
  ...
  std::cout << "avg number of breakable nodes (pasta): " 
            << static_cast<double>(graph.get_num_breakable_nodes()) / num_incre_itr << "\n";
  std::cout << "avg number of selected breakable nodes (pasta): " 
            << static_cast<double>(graph.get_num_selected_breakable_nodes()) / num_incre_itr << "\n";
